...
<body>
    ...
    <div class="contract-content">
        <div class="party-info">
            ...
            <p><strong>联系电话：</strong>{{companyPhone}}</p>
            <p><strong>法定代表人：</strong>{{companyLegalPerson}}</p>
        </div>
    ...
    <div class="signature-section">
        <div>
            <p>甲方（盖章）：</p>
            <img src="/zhang.png" alt="公司印章" style="width: 120px; height: 120px; margin: 10px 0;">
