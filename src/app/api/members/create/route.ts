    ...
    if (memberId) {
      try {
        await syncMemberToGoogleSheet({
          ...
          house_car: data.house_car || null,
          hukou_province: data.hukou_province || null,
          hukou_city: data.hukou_city || null,
          children_plan: data.children_plan || null,
          marriage_cert: data.marriage_cert || null,
          ...
          partner_requirement: data.partner_requirement || null,
          type: data.type || 'NORMAL',
          status: 'ACTIVE',
          education: data.education || null,
          occupation: data.occupation || null,
          remaining_matches: data.gender === 'female' ? 1 : 0,
