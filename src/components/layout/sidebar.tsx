...
export function Sidebar({ className, onMenuClick }: SidebarProps) {
  ...
  return (
    <div className={cn('h-full', className)}>
      {/* 桌面端侧边栏 */}
      <div className="hidden md:flex h-screen w-[57px] hover:w-[207px] flex-col bg-card border-r border-border transition-all duration-300 overflow-hidden group/sidebar relative z-[1001]">
